...
/**
 * Created by 20251496 on 2016/9/18.
 */

public class ColorProgressBar extends View {

    private int diameter = 82;  //直径
...
//    private float sweepAngle = 270;
    ...
    private float textSize = dipToPx(20);
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColorProgressBar);
        int color1 = a.getColor(R.styleable.ColorProgressBar_front_color1, Color.GREEN);
        int color2 = a.getColor(R.styleable.ColorProgressBar_front_color2, color1);
        int color3 = a.getColor(R.styleable.ColorProgressBar_front_color3, color1);
        colors = new int[]{color1, color2, color3, color3};

//      sweepAngle = a.getInteger(R.styleable.ColorArcProgressBar_total_engle, 0);
        sweepAngle = a.getInteger(R.styleable.ColorProgressBar_total_engle, 270);
        bgArcWidth = a.getDimension(R.styleable.ColorProgressBar_back_width, dipToPx(2));
        progressWidth = a.getDimension(R.styleable.ColorProgressBar_front_width, dipToPx(10));
        curValues = a.getFloat(R.styleable.ColorProgressBar_current_value, 0);
        maxValues = a.getFloat(R.styleable.ColorProgressBar_max_value, 60);
...
//        rotateMatrix.setRotate(130, centerX, centerY);
        rotateMatrix.setRotate(300, centerX, centerY);
